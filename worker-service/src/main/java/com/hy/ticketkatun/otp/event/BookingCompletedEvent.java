...
public class BookingCompletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1696366596928652894L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BookingCompletedEvent\",\"namespace\":\"com.hy.ticketkatun.otp.event\",\"fields\":[{\"name\":\"seatNumber\",\"type\":\"string\"},{\"name\":\"trainName\",\"type\":\"string\"}]}");
   ...
   */
  public BookingCompletedEvent(java.lang.CharSequence seatNumber, java.lang.CharSequence trainName) {
